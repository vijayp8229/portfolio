                ...
                <div className="hidden md:flex items-center gap-8">
                    {navLinks.map((link) => (
                        <a
                            key={link.title}
                            href={link.href}
                            className="text-zinc-600 dark:text-zinc-400 hover:text-black dark:hover:text-white transition-colors text-sm font-medium tracking-wider uppercase"
                        >
                            {link.title}
                        </a>
                    ))}
                        ...
                        <div className="flex flex-col items-center py-8 gap-6">
                            {navLinks.map((link) => (
                                <a
                                    ...
                                    className="text-xl text-gray-600 dark:text-gray-300 hover:text-black dark:hover:text-white font-medium"
                                >
                                    {link.title}
                                </a>
                            ))}
